...
image1 = cv2.imread("Object Detection/circles2.png", cv2.IMREAD_COLOR )
...
detectedcircles = cv2.HoughCircles(blurgrey, cv2.HOUGH_GRADIENT, 1, 20, param1=50, param2= 30, minRadius=1, maxRadius=200)
...
if detectedcircles is not None:
    ...
    for i in detectedcircles[0,:]:
        x,y,z = i[0], i[1], i[2]
        cv2.circle(image1, (x,y), z, (255,0,0), 5)
        cv2.circle(image1, (x,y), 1, (0, 0, 255), 5)
