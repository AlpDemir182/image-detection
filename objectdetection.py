...
image1 = cv2.imread("Object Detection/circles.png", cv2.IMREAD_COLOR )
...
detectedcircles = cv2.HoughCircles(blurgrey, cv2.HOUGH_GRADIENT, 1, 20, param1=50, param2= 30, minRadius=1, maxRadius=50)
